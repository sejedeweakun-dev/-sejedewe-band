...
export default function Home() {
  return (
    // SEKARANG: Background diubah menjadi warna hangat (zinc-950) yang menyesuaikan dengan warna logo
    <main className="min-h-screen bg-[#0A0D0A] text-white font-sans antialiased pb-16">
      
      {/* --- HEADER DENGAN LOGO (YANG TADI HILANG) --- */}
      <header className="flex flex-col items-center pt-8 pb-4 border-b border-zinc-800/60 bg-[#0A0D0A]/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="relative w-48 h-16 md:w-56 md:h-20 mb-2">
          <Image
            // GANTI INI dengan nama file logo kamu di folder public (misal: /logo1.png)
            src="/logo1.png" 
            alt="Sejedewe Logo"
            fill
        ...
        <p className="text-xs uppercase tracking-widest text-amber-500 font-semibold px-4 text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8 space-y-8">
        ...
        {/* Main Hero Card */}
        <section className="relative overflow-hidden rounded-2xl bg-[#0F120F] border border-zinc-800 p-6 md:p-8 shadow-2xl">
          <div className="relative w-full aspect-[16/9] md:aspect-[21/9] mb-6 rounded-xl overflow-hidden bg-black/40">
            <Image
              src="/personel.png" // Menggunakan file foto personel di folder public
          ...
          <div className="space-y-2">
            ...
            {/* Warna judul disesuaikan dengan logo */}
        ...
        {/* Tentang Sejedewe */}
        <section className="bg-[#0F120F]/90 border border-zinc-800 rounded-2xl p-6 md:p-8">
          <h2 className="text-2xl font-bold text-amber-400 mb-4 border-b border-zinc-800/60 pb-2">
            Tentang Sejedewe
          </h2>
        ...
        <section className="bg-[#0F120F]/90 border border-zinc-800 rounded-2xl p-6 md:p-8">
          ...
          <a
            ...
            className="group relative flex flex-col items-center justify-center w-full aspect-[16/6] bg-zinc-950 border border-zinc-800 hover:border-red-600/60 rounded-xl overflow-hidden transition duration-300 p-6 text-center shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Booking Contact */}
          <section className="bg-gradient-to-br from-[#0F120F] to-[#0A0D0A] border border-amber-500/30 rounded-2xl p-6 flex flex-col shadow-lg">
            <div>
          ...
          <section className="bg-[#0F120F]/90 border border-zinc-800 rounded-2xl p-6 flex flex-col shadow-lg">
            <div>
            ...
            <div className="space-y-3 mt-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3 rounded-xl bg-zinc-800/40 hover:bg-zinc-800 border border-zinc-700/50 transition group"
              >
                ...
                <span className="text-xs text-amber-400 font-medium group-hover:translate-x-1 transition-transform">S subscribe &rarr;</span>
              </a>
              ...
              >
                ...
                <span className="text-xs text-amber-400 font-medium group-hover:translate-x-1 transition-transform">F follow &rarr;</span>
              </a>
            </div>
          </section>
        </div>
      ...
      {/* Footer */}
      <footer className="mt-16 text-center text-zinc-600 text-xs border-t border-zinc-800/60 pt-8 pb-4">
        <p>&copy; {new Date().getFullYear()} Sejedewe Reggae Band. All rights reserved.</p>
        <p className="mt-1 text-zinc-700">Official Profile Website</p>
      </footer>
    </main>
  );
}