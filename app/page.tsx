        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="bg-[#1a1d1a] border border-amber-500/30 rounded-2xl p-6 flex flex-col shadow-md">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto flex items-center justify-center gap-2 w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-4 rounded-xl transition text-sm text-center"
            >
          ...
          <section className="bg-[#1a1d1a] border border-zinc-800 rounded-2xl p-6 flex flex-col shadow-md">
            ...
            <div className="space-y-3 mt-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3 rounded-xl bg-zinc-800/40 hover:bg-zinc-800 border border-zinc-700/40 transition"
              >
